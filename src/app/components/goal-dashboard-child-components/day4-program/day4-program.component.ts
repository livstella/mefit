...
@Component({
  selector: 'app-day4-program',
  templateUrl: './day4-program.component.html',
  styleUrls: ['./day4-program.component.css']
})
export class Day4ProgramComponent implements OnInit {
